...
var toAmount = document.querySelector('.to_amount');
...
function generateOptions(options) {
  return Object.entries(options).map(function (_ref) {
    ...
    return "<option value=\"".concat(currencyCode, "\">").concat(currencyCode, " - ").concat(currencyName, "</options>");
  }).join("");
}
...
function _fetchRates() {
  _fetchRates = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var base,
        res,
        rates,
        _args = arguments;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return fetch("".concat(endpoint, "?base=").concat(base));
...
function _convert() {
  _convert = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(amount, from, to) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log("on no we don't have ".concat(from, " to convert to ").concat(to, ". So lets go get it!"));
            _context2.next = 5;
...
function handleInput(_x4) {
  return _handleInput.apply(this, arguments);
}

function _handleInput() {
  _handleInput = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var rawAmount;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return convert(fromInput.value, fromSelect.value, toSelect.value);
...
var optionsHTML = generateOptions(currencies); //populate options
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","currencyConverter.js"], null)
//# sourceMappingURL=/currencyConverter.d12aa9c9.js.map